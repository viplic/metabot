...
export function buildResponsesBody({ text, imageParts = [], config, conversation, knowledgeMatches = [], model = null }) {
  ...
  const instructions = [
    ...
    "Odgovaraj kao stvarna osoba u prodaji: najvise 1-2 kratke recenice, bez nabrajanja osim ako korisnik trazi detalje.",
    "Ne salji linkove, URL-ove, interne nazive polja, slike iz baze ni tehnicke blokove, osim ako korisnik izricito trazi link.",
